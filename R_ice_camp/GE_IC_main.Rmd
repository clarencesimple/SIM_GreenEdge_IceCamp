...
indic_substrate_top<-rbind(indic_phyto_ice[1:25,],indic_phyto_water[1:25,])
# How much of the reads do the top 25 ASVs represent in their respective groupings
sum(indic_phyto_ice$total_reads[1:25])/sum(indic_phyto_ice$total_reads)
sum(indic_phyto_water$total_reads[1:25])/sum(indic_phyto_water$total_reads)
...
indic_bloom_cluster_top<-rbind(indic_phyto_Stage_I[1:25,],indic_phyto_Stages_II_and_III[1:25,])
# How much of the reads do the top 25 ASVs represent in their respective groupings
sum(indic_phyto_Stage_I$total_reads[1:25])/sum(indic_phyto_ice$total_reads)
sum(indic_phyto_Stages_II_and_III$total_reads[1:25])/sum(indic_phyto_water$total_reads)
...
labels <- plot_phyto %>% 
  filter(n_reads>=0.20*normalised_reads) %>% 
...
plot_phyto$label_white <- ifelse(plot_phyto$label %in% c("Sc","Ol","Mp","P1","P2","P3","C3","C4","C5"), plot_phyto$label, NA)
plot_phyto$label_black <- ifelse(plot_phyto$label %in% c("Pr","Bf","Pa","Pp","P4","P5","P6","P7","P8","C1","C2"), plot_phyto$label, NA)
