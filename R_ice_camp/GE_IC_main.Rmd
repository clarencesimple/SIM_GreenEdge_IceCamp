...
# Checking for boostrap values to make sure taxa name is accurate
kable(indic_substrate_top%>%select(species,family_boot,genus_boot,species_boot,substrate))
...
# Checking for boostrap values to make sure taxa name is accurate
kable(indic_bloom_cluster_top%>%select(species,family_boot,genus_boot,species_boot,bloom_cluster))
