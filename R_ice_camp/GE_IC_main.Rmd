...
```{r fig.height=10, fig.width=18}
pdf("../main_figures/environmental_parameters.pdf", height=16, width=22); plot(par_plot/chla_plot_massicotte/fcm_plot/plot_ice_snow/plot_depth); dev.off() 
```
...
pdf("../supplementary_figures/supplementary_indicatorASV_substrate.pdf", height=17, width=24); plot(indic_substrate_plot); dev.off() 
```
...
indic_substrate <- read_excel("../supplementary_tables/GE_IC_indicspecies.xlsx", sheet="substrate_Stage_I")
...
pdf("../supplementary_figures/supplementary_indicatorASV_substrate_stage_I.pdf", height=17, width=24); plot(indic_substrate_plot); dev.off() 
```
...
indic_substrate <- read_excel("../supplementary_tables/GE_IC_indicspecies.xlsx", sheet="substrate_Stages_II_and_III")
...
pdf("../supplementary_figures/indicatorASV_substrate_stages_II_and_III.pdf", height=17, width=24); plot(indic_substrate_plot); dev.off() 
```
...
pdf("../supplementary_figures/supplementary_indicatorASV_bloom_cluster.pdf", height=17, width=24); plot(indic_bloom_cluster_plot); dev.off() 
...
biogeo <- read.csv("../R_ice_camp/biogeoraphy_assignment_metaPR2/biogeo_casv.csv") %>% 
  select(-X)
phyto_biogeo <- left_join(phyto_taxa %>% rownames_to_column("asv_code") %>% select(asv_code, casv_code), biogeo, by="casv_code") %>%
  na.omit()
...
##
## Run GE_IC_biogeo.Rmd from Lines 1 to 68 to get long_meta dataframe
##
...
pdf(str_c("../supplementary_figures/ASV_biogeo/supplementary_ASV_",i,".pdf"), height=8, width=24) ; plot(plot_time+plot_map_ortho+plot_map_world); dev.off() 
}
